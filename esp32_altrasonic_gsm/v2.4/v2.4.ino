/*
  ...
  - Tank depth (in mm) configurable via web page (default 7000mm = 7m)
  - Sensor value is distance in mm (from sensor to water)
...
void setup() {
  Serial.begin(115200);
  delay(100);
  Serial.println("ESP32 + A7670C: Modbus -> GSM POST (full payload) with 2 pumps (mm only)");
